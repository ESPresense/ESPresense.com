...
const ge = (i) => new oe(typeof i == "string" ? i : i + "", void 0, q), ne = (i, ...e) => {
...
const { is: fe, defineProperty: me, getOwnPropertyDescriptor: $e, getOwnPropertyNames: ye, getOwnPropertySymbols: ve, getPrototypeOf: _e } = Object, T = globalThis, J = T.trustedTypes, we = J ? J.emptyScript : "", xe = T.reactiveElementPolyfillSupport, E = (i, e) => i, z = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? we : null;
      break;
  ...
  return t;
} }, ae = (i, e) => !fe(i, e), Y = { attribute: !0, type: String, converter: z, reflect: !1, useDefault: !1, hasChanged: ae };
...
_.elementStyles = [], _.shadowRootOptions = { mode: "open" }, _[E("elementProperties")] = /* @__PURE__ */ new Map(), _[E("finalized")] = /* @__PURE__ */ new Map(), xe?.({ ReactiveElement: _ }), (T.reactiveElementVersions ??= []).push("2.1.2");
const I = globalThis, Q = (i) => i, R = I.trustedTypes, X = R ? R.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, le = "$lit$", m = `lit$${Math.random().toFixed(9).slice(2)}$`, he = "?" + m, Ae = `<${he}>`, v = document, k = () => v.createComment(""), C = (i) => i === null || typeof i != "object" && typeof i != "function", K = Array.isArray, Se = (i) => K(i) || typeof i?.[Symbol.iterator] == "function", N = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ee = /-->/g, te = />/g, $ = RegExp(`>|${N}(?:([^\\s"'>=/]+)(${N}*=${N}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), se = /'/g, re = /"/g, ce = /^(?:script|style|textarea|title)$/i, de = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), g = de(1), ze = de(2), x = /* @__PURE__ */ Symbol.for("lit-noChange"), u = /* @__PURE__ */ Symbol.for("lit-nothing"), ie = /* @__PURE__ */ new WeakMap(), y = v.createTreeWalker(v, 129);
function pe(i, e) {
...
const Ee = (i, e) => {
  ...
  for (let c = 0; c < t; c++) {
    ...
    o += n === S ? l + Ae : a >= 0 ? (s.push(d), l.slice(0, a) + le + l.slice(a) + m + b) : l + m + (a === -2 ? c : b);
  }
...
class P {
  constructor({ strings: e, _$litType$: t }, s) {
    ...
    if (this.el = P.createElement(d, s), y.currentNode = this.el.content, t === 2 || t === 3) {
    ...
    for (; (r = y.nextNode()) !== null && l.length < c; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const a of r.getAttributeNames()) if (a.endsWith(le)) {
          const h = p[n++], b = r.getAttribute(a).split(m), O = /([.?@])?(.*)/.exec(h);
          l.push({ type: 1, index: o, name: O[2], strings: b, ctor: O[1] === "." ? Ce : O[1] === "?" ? Pe : O[1] === "@" ? Me : H }), r.removeAttribute(a);
        } else a.startsWith(m) && (l.push({ type: 6, index: o }), r.removeAttribute(a));
        if (ce.test(r.tagName)) {
          const a = r.textContent.split(m), h = a.length - 1;
          if (h > 0) {
        ...
        let a = -1;
        for (; (a = r.data.indexOf(m, a + 1)) !== -1; ) l.push({ type: 7, index: o }), a += m.length - 1;
      }
      o++;
    }
  }
...
class M {
  ...
  _$AI(e, t = this) {
    e = A(this, e, t), C(e) ? e === u || e == null || e === "" ? (this._$AH !== u && this._$AR(), this._$AH = u) : e !== this._$AH && e !== x && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Se(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== u && C(this._$AH) ? this._$AA.nextSibling.data = e : this.T(v.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    const { values: t, _$litType$: s } = e, r = typeof s == "number" ? this._$AC(e) : (s.el === void 0 && (s.el = P.createElement(pe(s.h, s.h[0]), this.options)), s);
  ...
  _$AC(e) {
    ...
    return t === void 0 && ie.set(e.strings, t = new P(e)), t;
  }
  k(e) {
...
class H {
  ...
  _$AI(e, t = this, s, r) {
    ...
    let n = !1;
    if (o === void 0) e = A(this, e, t, 0), n = !C(e) || e !== this._$AH && e !== x, n && (this._$AH = e);
    else {
      const c = e;
      let l, d;
      for (e = o[0], l = 0; l < o.length - 1; l++) d = A(this, c[s + l], t, l), d === x && (d = this._$AH[l]), n ||= !C(d) || d !== this._$AH[l], d === u ? e = u : e !== u && (e += (d ?? "") + o[l + 1]), this._$AH[l] = d;
    }
    n && !r && this.j(e);
  }
  j(e) {
...
Ue?.(P, M), (I.litHtmlVersions ??= []).push("3.3.2");
const Re = (i, e, t) => {
...
const ue = async (i) => {
  import("./install-dialog-DPpuFJfQ.js");
  let e;
  try {
    e = await navigator.serial.requestPort();
  } catch (s) {
    if (s.name === "NotFoundError") {
      import("./index-CjwzWWnd.js").then((r) => r.openNoPortPickedDialog(() => ue(i)));
      return;
    }
